  ...
  class BusinessHours
    ...
    def <=>(other)
      if other.class != self.class
        raise ArgumentError.new("#{self.class.name} can't be compared with #{other.class.name}")
      end
    ...
    def calculate_before(time, hours, options = {})
      ...
      hours.times do
        ...
        if before_time.hour == 0 && before_time.min == 0 && before_time.sec == 0
          ...
          time_roll_backward += 1.second if time_roll_backward.iso8601.match?(/23:59:59/)
